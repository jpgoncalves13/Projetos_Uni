...
\\[\blanklineskip]%
\>[B]{}\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

E podemos relacionar a função \ensuremath{\Varid{g}} com a função \ensuremath{\Varid{j}}:

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{cases}
      \begin{cases}
        \ensuremath{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}}\\
        \ensuremath{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{a}\mathbin{*}\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathbin{+}\Varid{b}\mathbin{*}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathbin{+}\Varid{c}\mathbin{*}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}}\\  
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}} 
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{0}}\\
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}
\end{cases}
\end{eqnarray*}
...
\start  \begin{cases}
            \begin{cases}
              \ensuremath{(\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}}\\
              \ensuremath{(\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ \mathrel{=}\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}
            \end{cases}\\
            \begin{cases}
              \ensuremath{(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}}\\
              \ensuremath{(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ \mathrel{=}\p1\comp \p1\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}
            \end{cases}\\
            \begin{cases}
              \ensuremath{(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{0}}}\\
              \ensuremath{(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ \mathrel{=}\p2\comp \p1\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}
            \end{cases}
        \end{cases}
%
...
%
\begin{cases}
  \ensuremath{(\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \alt{\underline{\mathrm{0}}}{\succ }\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}}\\
  \ensuremath{(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \alt{\underline{\mathrm{0}}}{\succ }\mathrel{=}\alt{\underline{\mathrm{1}}}{\p1\comp \p1\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}}\\
  \ensuremath{(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \alt{\underline{\mathrm{0}}}{\succ }\mathrel{=}\alt{\underline{\mathrm{0}}}{\p2\comp \p1\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}}
\end{cases}
%
\just\equiv{ Defenição de in; Natural-id }
%
\begin{cases}
  \ensuremath{(\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}\comp \Varid{id}}{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}}\\
  \ensuremath{(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}\comp \Varid{id}}{\p1\comp \p1\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}}\\
  \ensuremath{(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}\comp \Varid{id}}{\p2\comp \p1\comp \conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}}       
\end{cases}
%
\just\equiv{ 3x Absorção-+ }
%
\begin{cases}
  \ensuremath{(\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}}\comp \mathrm{1}\mathbin{+}\conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}\\
  \ensuremath{(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\p1\comp \p1}\comp \mathrm{1}\mathbin{+}\conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}\\
  \ensuremath{(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\p2\comp \p1}\comp \mathrm{1}\mathbin{+}\conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}
\end{cases}
%
\just\equiv{ Fokkinga }
%
\ensuremath{\conj{\conj{\Varid{j}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}\mathrel{=}\llparenthesis\, \conj{\conj{\alt{\underline{\mathrm{1}}}{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}}}{\alt{\underline{\mathrm{1}}}{\p1\comp \p1}}}{\alt{\underline{\mathrm{0}}}{\p2\comp \p1}}\,\rrparenthesis}
\qed
\end{eqnarray*}

Mostrando assim que a podemos escrever a função \ensuremath{\Varid{f}} a partir de um catamorfismo. Como obtemos o catamorfismo, podemos 
converter para um ciclo for de acordo com a definição:

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\for{\Varid{b}}\ {\Varid{i}}\mathrel{=}\llparenthesis\, \alt{\underline{\Varid{i}}}{\Varid{b}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
\ensuremath{\llparenthesis\, \conj{\conj{\alt{\underline{\mathrm{1}}}{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}}}{\alt{\underline{\mathrm{1}}}{\p1\comp \p1}}}{\alt{\underline{\mathrm{0}}}{\p2\comp \p1}}\,\rrparenthesis}
%
\just\equiv{ Lei da troca }
%
\ensuremath{\llparenthesis\, \conj{\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}}{\p1\comp \p1}}}{\alt{\underline{\mathrm{0}}}{\p2\comp \p1}}\,\rrparenthesis}
%
\just\equiv{ Lei da troca }
%
\ensuremath{\llparenthesis\, \alt{\conj{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\underline{\mathrm{0}}}}{\conj{\conj{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}}{\p1\comp \p1}}{\p2\comp \p1}}\,\rrparenthesis}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
\ensuremath{\underline{\Varid{i}}\mathrel{=}\conj{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\underline{\mathrm{0}}}}
%
\just\equiv{ Universal-x }
% 
\ensuremath{\begin{lcbr}\p1\comp \underline{\Varid{i}}\mathrel{=}\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}\\\p2\comp \underline{\Varid{i}}\mathrel{=}\underline{\mathrm{0}}\end{lcbr}}
%
\just\equiv{ Universal-x; Fusão-const }
%
\ensuremath{\begin{lcbr}\begin{lcbr}\p1\comp \p1\comp \underline{\Varid{i}}\mathrel{=}\underline{\mathrm{1}}\\\p2\comp \p1\comp \underline{\Varid{i}}\mathrel{=}\underline{\mathrm{1}}\end{lcbr}\\\underline{\p2\comp \Varid{i}}\mathrel{=}\underline{\mathrm{0}}\end{lcbr}}
%
\just\equiv{ 2x Fusão-const; \ensuremath{\underline{\Varid{a}}\mathrel{=}\underline{\Varid{b}}} se \ensuremath{\Varid{a}\mathrel{=}\Varid{b}}}
%
\ensuremath{\begin{lcbr}\begin{lcbr}\underline{\p1\comp \p1\comp \Varid{i}}\mathrel{=}\underline{\mathrm{1}}\\\underline{\p2\comp \p1\comp \Varid{i}}\mathrel{=}\underline{\mathrm{1}}\end{lcbr}\\\p2\comp \Varid{i}\mathrel{=}\mathrm{0}\end{lcbr}}
%
\just\equiv{ 2x \ensuremath{\underline{\Varid{a}}\mathrel{=}\underline{\Varid{b}}} se \ensuremath{\Varid{a}\mathrel{=}\Varid{b}}}
%
\ensuremath{\begin{lcbr}\begin{lcbr}\p1\comp \p1\comp \Varid{i}\mathrel{=}\mathrm{1}\\\p2\comp \p1\comp \Varid{i}\mathrel{=}\mathrm{1}\end{lcbr}\\\p2\comp \Varid{i}\mathrel{=}\mathrm{0}\end{lcbr}}
%
\just\equiv{ Universal-x }
%
\ensuremath{\begin{lcbr}\p1\comp \Varid{i}\mathrel{=}(\mathrm{1},\mathrm{1})\\\p2\comp \Varid{i}\mathrel{=}\mathrm{0}\end{lcbr}}
%
\just\equiv{ Universal-x }
%
\ensuremath{\Varid{i}\mathrel{=}((\mathrm{1},\mathrm{1}),\mathrm{0})}
\qed
\end{eqnarray*}

Obtendo o \ensuremath{\Varid{initial}}.
...
\begin{eqnarray*}
\start
\ensuremath{\conj{\conj{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}}{\p1\comp \p1}}{\p2\comp \p1}\;((\Varid{h},\Varid{k}),\Varid{l})}
%
\just\equiv{ Def-split }
% 
\ensuremath{(\conj{\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}}{\p1\comp \p1}\;((\Varid{h},\Varid{k}),\Varid{l}),(\p2\comp \p1)\;((\Varid{h},\Varid{k}),\Varid{l}))}
%
\just\equiv{ Def-split; Def-comp }
% 
\ensuremath{((\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}\;((\Varid{h},\Varid{k}),\Varid{l}),(\p1\comp \p1)\;((\Varid{h},\Varid{k}),\Varid{l})),\p2\;(\p1\;((\Varid{h},\Varid{k}),\Varid{l})))}
%
\just\equiv{ 2x Def-comp; Def-proj }
% 
\ensuremath{((\Varid{add}\;(\conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}}{(\Varid{c}\mathbin{*})\comp \p2}\;((\Varid{h},\Varid{k}),\Varid{l})),\p1\;(\p1\;((\Varid{h},\Varid{k}),\Varid{l}))),\p2\;(\Varid{h},\Varid{k}))}
%
\just\equiv{ Def-split; 2x Def-proj }
% 
\ensuremath{((\Varid{add}\;(\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp \p1\comp \p1}{(\Varid{b}\mathbin{*})\comp \p2\comp \p1}\;((\Varid{h},\Varid{k}),\Varid{l}),((\Varid{c}\mathbin{*})\comp \p2)\;((\Varid{h},\Varid{k}),\Varid{l})),\p1\;(\Varid{h},\Varid{k})),\Varid{k})}
%
\just\equiv{ 2x Def-comp; Def-proj }
% 
\ensuremath{((\Varid{add}\;(\Varid{add}\;(((\Varid{a}\mathbin{*})\comp \p1\comp \p1)\;((\Varid{h},\Varid{k}),\Varid{l}),((\Varid{b}\mathbin{*})\comp \p2\comp \p1)\;((\Varid{h},\Varid{k}),\Varid{l})),(\Varid{c}\mathbin{*})\;(\p2\;(\Varid{h},\Varid{l}))),\Varid{h}),\Varid{k})}
%
\just\equiv{ 2x Def-comp; Def-proj }
% 
\ensuremath{((\Varid{add}\;(\Varid{add}\;(((\Varid{a}\mathbin{*})\comp \p1)\;(\p1\;((\Varid{h},\Varid{k}),\Varid{l})),((\Varid{b}\mathbin{*})\comp \p2)\;(\p1\;((\Varid{h},\Varid{k}),\Varid{l}))),(\Varid{c}\mathbin{*})\;\Varid{l}),\Varid{h}),\Varid{k})}
%
\just\equiv{ 2x Def-proj; Definição de \ensuremath{\mathbin{*}} }
% 
\ensuremath{((\Varid{add}\;(\Varid{add}\;(((\Varid{a}\mathbin{*})\comp \p1)\;(\Varid{h},\Varid{k}),((\Varid{b}\mathbin{*})\comp \p2)\;(\Varid{h},\Varid{k})),\Varid{c}\mathbin{*}\Varid{l}),\Varid{h}),\Varid{k})}
%
\just\equiv{ 2x Def-comp }
% 
\ensuremath{((\Varid{add}\;(\Varid{add}\;((\Varid{a}\mathbin{*})\;(\p1\;(\Varid{h},\Varid{k})),(\Varid{b}\mathbin{*})\;(\p2\;(\Varid{h},\Varid{k}))),\Varid{c}\mathbin{*}\Varid{l}),\Varid{h}),\Varid{k})}
%
\just\equiv{ 2x Def-proj }
% 
\ensuremath{((\Varid{add}\;(\Varid{add}\;((\Varid{a}\mathbin{*})\;\Varid{h},(\Varid{b}\mathbin{*})\;\Varid{k}),\Varid{c}\mathbin{*}\Varid{l}),\Varid{h}),\Varid{k})}
%
\just\equiv{ 2x Definição de \ensuremath{\mathbin{*}} }
% 
\ensuremath{((\Varid{add}\;(\Varid{add}\;(\Varid{a}\mathbin{*}\Varid{h},\Varid{b}\mathbin{*}\Varid{k}),\Varid{c}\mathbin{*}\Varid{l}),\Varid{h}),\Varid{k})}
%
\just\equiv{ Definição de \ensuremath{\Varid{add}} }
% 
\ensuremath{((\Varid{add}\;(\Varid{a}\mathbin{*}\Varid{h}\mathbin{+}\Varid{b}\mathbin{*}\Varid{k},\Varid{c}\mathbin{*}\Varid{l}),\Varid{h}),\Varid{k})}
\just\equiv{ Definição de \ensuremath{\Varid{add}} }
% 
\ensuremath{((\Varid{a}\mathbin{*}\Varid{h}\mathbin{+}\Varid{b}\mathbin{*}\Varid{k}\mathbin{+}\Varid{c}\mathbin{*}\Varid{l},\Varid{h}),\Varid{k})}
\qed
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{j},\Varid{g}),\Varid{f})\mathrel{=}((\Varid{a}\mathbin{*}\Varid{j}\mathbin{+}\Varid{b}\mathbin{*}\Varid{g}\mathbin{+}\Varid{c}\mathbin{*}\Varid{f},\Varid{j}),\Varid{g}){}\<[E]%
\\
...
O gene será uma a composição de duas funções, a \ensuremath{\Varid{out}} e um função que é um \ensuremath{\alt{\cdot }{\cdot }}.
Para podermos definir as duas componentes do \ensuremath{\alt{\cdot }{\cdot }} é necessário perceber o resultado da função \ensuremath{\Varid{out}}.
A função \ensuremath{\Varid{out}} é o \ensuremath{\Varid{out}} das listas não vazias. No caso da lista só com um elemento,
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}(\text{\ttfamily \char34 CCS\char34},[\mskip1.5mu \text{\ttfamily \char34 ~~~~General~and~reference\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~Document~types\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~~~~~Surveys~and~overviews\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~~~~~Reference~works\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~~~~~General~conference~proceedings\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~~~~~Biographies\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~~~~~General~literature\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~~~~~Computing~standards,~RFCs~and~guidelines\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~~~~~Cross-computing~tools~and~techniques\char34}\mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Neste segundo caso na cabeça ficará o primeiro elemento da lista, ou seja, a \ensuremath{\Conid{String}} não identada que é um operador, à qual basta aplicar a função identidade.
Na cauda da lista ficam as \ensuremath{\Conid{String}} com identação. Para remover a identação é necessário remover os 4 espaços 
de todos os elementos e para isso usamos a função \ensuremath{\map \;(\Varid{take}\;\mathrm{4})} ficando o par da seguinte forma:
...
Cada lista nova terá a cabeça, ou seja, a \ensuremath{\Conid{String}} sem identação e as \ensuremath{\Conid{String}} com hierarquia inferior a esta, com identação.  
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}(\text{\ttfamily \char34 CCS\char34},[\mskip1.5mu [\mskip1.5mu \text{\ttfamily \char34 General~and~reference\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~Document~types\char34},{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 ~~~~Cross-computing~tools~and~techniques\char34}\mskip1.5mu]\mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Assim sendo, o gene de \ensuremath{\Varid{tax}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gene}\mathrel{=}(\Varid{id}+(\Varid{id}\times\Varid{groupBy}\;(\lambda \Varid{x}\;\Varid{y}\to \Varid{take}\;\mathrm{4}\;\Varid{y}\equiv \text{\ttfamily \char34 ~~~~\char34})\comp \map \;(\Varid{drop}\;\mathrm{4})))\comp \Varid{out}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3cm{
    \ensuremath{\Conid{Exp}\;\Conid{S}\;\Conid{S}}
           \ar[d]_-{\ensuremath{\llparenthesis\, \Varid{g}\,\rrparenthesis_\textit{\tiny Exp}}}
&
    S + S \times (\ensuremath{\Conid{Exp}\;\Conid{S}\;\Conid{S}})^*
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}} \times \ensuremath{\llparenthesis\, \Varid{g}\,\rrparenthesis_\textit{\tiny Exp}}}
           \ar[l]_-{\ensuremath{\mathsf{in}_{\tiny\ \textit{Exp}}}}
\\
     (S^*)^*
&
     S + S \times ((S^*)^*)^*
           \ar[l]^-{\ensuremath{\Varid{gnp}}}
}
\end{eqnarray*}

Depois de identificarmos o catamorfismo de árvores de expressão, passamos à fase de identificar qual o seu gene.  
No caso do lado esquerdo apenas precisamos de colocar a \ensuremath{\Conid{String}} dentro de uma lista e esta dentro de outra lista. 
No caso do lado direito é necessário perceber qual é o resultado do lado direito do par, que são as listas com os caminhos que é possível tomar a partir da \ensuremath{\Conid{String}} do lado esquerdo do par.   
Assim sendo, necessitamos de introduzir à cabeça de cada um desses caminhos a \ensuremath{\Conid{String}} do lado esquerdo. 
Para isso, primeiro a lista com as listas dos caminhos são concatenadas para possuírmos a lista com os caminhos.   
Em seguida, acrescentamos à cabeça de todos os caminhos a \ensuremath{\Conid{String}} do lado esquerdo e acrescentamos mais um caminho para que seja possível chegar ao nível desta \ensuremath{\Conid{String}}, visto que queremos todos os caminhos da árvore.   
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{post}\mathrel{=}\llparenthesis\, \Varid{gnp}\,\rrparenthesis_\textit{\tiny Exp}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{gnp}\mathrel{=}\alt{\Varid{gnp1}}{\Varid{gnp2}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{gnp1}\;\Varid{x}\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{x}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{gnp2}\;(\Varid{x},\Varid{l})\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathbin{:}\map \;(\Varid{x}\mathbin{:})\;(\Varid{concat}\;\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    A \times (\ensuremath{\Conid{Rose}\;\Conid{A}})^*
           \ar[d]^{\ensuremath{\Varid{id}} \times \ensuremath{\llparenthesis\, \Varid{gr2l}\,\rrparenthesis_\textit{\tiny R}}}
           \ar[l]_-{\ensuremath{\Varid{inRose}}}
\\
     A^*
&
     A \times (A^*)^*
...
\\[\blanklineskip]%
\>[B]{}\Varid{gr2l}\;(\Varid{a},\Varid{l})\mathrel{=}\Varid{a}\mathbin{:}\Varid{concat}\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix{
  \ensuremath{\Conid{Rose}\;\Conid{Square}} & & Square \times (\ensuremath{\Conid{Rose}\;\Conid{Square}})^*\ar[ll]_{\ensuremath{\Varid{inRose}}} \\
  Square \times N_0\ar@/_1.5pc/[rr]_{\ensuremath{\Varid{gsq}}}\ar[r]^(0.55){\ensuremath{\Varid{outNat}\comp \p2}}\ar[u]^{\ensuremath{\lanabracket\;\!\Varid{gsq}\;\!\ranabracket_\textit{\tiny R}}} & 1+(N_0)\ar[r]^(0.35){\cdots} & Square \times (Square,N_0)^*\ar[u]_{\ensuremath{\Varid{id}} \times \ensuremath{\map \;\llparenthesis\, \Varid{gr2l}\,\rrparenthesis_\textit{\tiny R}}}
}
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}\mathrel{=}\conj{\Varid{gsq1}}{\Varid{gsq2}}{}\<[E]%
\\
\>[B]{}\Varid{gsq1}\;(((\Varid{x},\Varid{y}),\Varid{z}),\Varid{w})\mathrel{=}((\Varid{x}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}){}\<[E]%
\\
\>[B]{}\Varid{gsq2}\;(((\Varid{x},\Varid{y}),\Varid{z}),\Varid{w})\mathrel{=}\mathbf{if}\;\Varid{w}\mathbin{>}\mathrm{0}\;\mathbf{then}\;[\mskip1.5mu (((\Varid{x},\Varid{y}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(((\Varid{x}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(((\Varid{x}\mathbin{+}(\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{y}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(((\Varid{x},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(((\Varid{x}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mathbf{else}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{carpets}\;\mathrm{0}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{carpets}\;\Varid{n}\mathrel{=}\Varid{carpets}\;(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{+\!\!\!+}[\mskip1.5mu \Varid{sierpinski}\;(((\mathrm{0},\mathrm{0}),\mathrm{32}),\Varid{n}\mathbin{-}\mathrm{1})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{present}\mathrel{=}\Varid{mmap}\;(\lambda \Varid{l}\to \mathbf{do}\;\{\mskip1.5mu \Varid{drawSq}\;\Varid{l};\Varid{await}\mskip1.5mu\}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{cgene}\mathrel{=}\alt{\Varid{cgene1}}{\Varid{cgene2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{cgene1}\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{cgene2}\;((\Varid{a},\Varid{b}),[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{cgene2}\;((\Varid{a},\Varid{b}),(a_1 ,b_1 )\mathbin{:}\Varid{l})\mathrel{=}\mathbf{if}\;\Varid{a}\equiv a_1 \;\mathbf{then}\;(\Varid{a},\Varid{b}\mathbin{+}b_1 )\mathbin{:}\Varid{l}{}\<[E]%
\\
\>[9]{}\hsindent{17}{}\<[26]%
\>[26]{}\mathbf{else}\;(a_1 ,b_1 )\mathbin{:}\Varid{cgene2}\;((\Varid{a},\Varid{b}),\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{matchResult}\;\Varid{gsCriteria}\;(\Varid{t1},\Varid{t2})\mathrel{=}\mathbf{if}\;\Varid{gsCriteria}\;(\Varid{t1},\Varid{t2})\equiv \Conid{Just}\;\Varid{t1}\;\mathbf{then}\;[\mskip1.5mu (\Varid{t1},\mathrm{3}),(\Varid{t2},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{34}{}\<[34]%
\>[34]{}\mathbf{else}\;\mathbf{if}\;\Varid{gsCriteria}\;(\Varid{t1},\Varid{t2})\equiv \Conid{Just}\;\Varid{t2}\;\mathbf{then}\;[\mskip1.5mu (\Varid{t1},\mathrm{0}),(\Varid{t2},\mathrm{3})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{34}{}\<[34]%
\>[34]{}\mathbf{else}\;[\mskip1.5mu (\Varid{t1},\mathrm{1}),(\Varid{t2},\mathrm{1})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{pairup}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\map \;(\lambda \Varid{y}\to (\Varid{x},\Varid{y}))\;\Varid{xs}\mathbin{+\!\!\!+}\Varid{pairup}\;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{glt}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Varid{a}+([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{glt}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{glt}\;\Varid{l}\mathrel{=}i_2\;(\Varid{splitAt}\;\Varid{n}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{where}\;\Varid{n}\mathrel{=}\length \;\Varid{l}\div \mathrm{2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix{
    \ensuremath{{\LTree}\;\Conid{A}} & & A -\ensuremath{\mathbin{-}(}LTree A\ensuremath{\lambda \Varid{times}}LTree A\ensuremath{)\mathbin{\char94 *}\lambda \Varid{ar}\;[\mskip1.5mu \Varid{ll}\mskip1.5mu]\;\anonymous \;\{\mskip1.5mu }inLTree\ensuremath{\mskip1.5mu\}\mathbin{\char92 \char92 }(\Conid{A}\mathbin{\char94 *})\lambda \Varid{ar}\mathbin{@@/\char95 }\mathrm{1.5}\;\Varid{pc}\mathbin{/}[\mskip1.5mu \Varid{rr}\mskip1.5mu]\;\anonymous \;\{\mskip1.5mu }glt\ensuremath{\mskip1.5mu\}\lambda \Varid{ar}\;[\mskip1.5mu \Varid{u}\mskip1.5mu]\mathbin{\uparrow}\{\mskip1.5mu }anaList gsq\ensuremath{\mskip1.5mu\}\mathbin{\&}\Conid{A}\mathbin{-}}- (A^* \times A)^*\ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\anaList{\Varid{glt}}\mathbin{+}\anaList{\Varid{glt}}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pinitKnockoutStage}\;\Varid{l}\mathrel{=}{}\<[25]%
\>[25]{}\mathbf{do}\;\{\mskip1.5mu \Varid{return}\;(\Varid{initKnockoutStage}\;\Varid{l})\mskip1.5mu\}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{pgroupWinners}\;\Varid{criteria}\mathrel{=}\mathsf{fmap}\;(\Varid{best}\;\mathrm{2}\comp \Varid{consolidate'}\comp \Varid{concat})\comp \Varid{mmap}\;(\Varid{pmatchResult}\;\Varid{criteria}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pmatchResult}\;\Varid{criteria}\;\Varid{m}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{r}\leftarrow \Varid{criteria}\;\Varid{m};\Varid{return}\;(\Varid{f}\;\Varid{m}\;\Varid{r})\mskip1.5mu\}{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\mathbf{where}\;\Varid{f}\;(\Varid{t1},\Varid{t2})\;\Conid{Nothing}\mathrel{=}[\mskip1.5mu (\Varid{t1},\mathrm{1}),(\Varid{t2},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[27]{}\hsindent{6}{}\<[33]%
\>[33]{}\Varid{f}\;(\Varid{t1},\Varid{t2})\;(\Conid{Just}\;\Varid{t})\mathrel{=}\mathbf{if}\;\Varid{t}\equiv \Varid{t1}\;\mathbf{then}\;[\mskip1.5mu (\Varid{t1},\mathrm{3}),(\Varid{t2},\mathrm{0})\mskip1.5mu]\;\mathbf{else}\;[\mskip1.5mu (\Varid{t1},\mathrm{0}),(\Varid{t2},\mathrm{3})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
